...
use App\Models\Employee\Certification;
...
class CertificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Certification::when(!empty($request->search), function ($q, $search) {
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if ($request->hasFile('file')) {
                ...
                $filePath = 'uploads/employee/' . $request->employee_id . '/certification/';
