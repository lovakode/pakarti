...
use App\Models\Employee\Medical;
...
class MedicalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Medical::when(!empty($request->search), function ($q, $search) {
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if ($request->hasFile('file')) {
                ...
                $filePath = 'uploads/' . $request->employee_id . '/medical/';
    ...
    public function update(Request $request, string $id)
    {
        ...
        try{
            ...
            $filePath = 'uploads/employee/' . $request->employee_id . '/medical/';
