...
use App\Models\Employee\Attachment;
...
class AttachmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Attachment::when(!empty($request->search), function ($q, $search) {
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if ($request->hasFile('file')) {
                ...
                $filePath = 'uploads/employee/' . $request->employee_id . '/attachments/';
    ...
    public function update(Request $request, string $id)
    {
        ...
        try{
            ...
            $filePath = 'uploads/employee/' . $request->employee_id . '/attachment/';
